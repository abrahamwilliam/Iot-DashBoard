...
import RendererWrapper0 from 'C:/Users/abrah/Downloads/CMPE280-TP/src/pages/.umi/LocaleWrapper.jsx'
...
let routes = [
  ...
  LoadingComponent: require('C:/Users/abrah/Downloads/CMPE280-TP/src/components/PageLoading/index').default,
}),
    "routes": [
      {
        "path": "/user",
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__User__models__register.js' */'C:/Users/abrah/Downloads/CMPE280-TP/src/pages/User/models/register.js').then(m => { return { namespace: 'register',...m.default}})
],
...
models: () => [
  ...
  LoadingComponent: require('C:/Users/abrah/Downloads/CMPE280-TP/src/components/PageLoading/index').default,
      ...
      {
        "component": () => React.createElement(require('C:/Users/abrah/Downloads/CMPE280-TP/node_modules/umi-build-dev/lib/plugins/404/NotFound.js').default, { pagesPath: 'src/pages', hasRoutesInConfig: true })
      }
    ]
  },
  {
  ...
  LoadingComponent: require('C:/Users/abrah/Downloads/CMPE280-TP/src/components/PageLoading/index').default,
    ...
    "routes": [
      {
        "path": "/",
        "redirect": "/dashboard/demodashboard",
        "exact": true
      },
      {
        "path": "/register",
  ...
  component: () => import(/* webpackChunkName: "p__Register__nodes" */'../Register/nodes'),
  LoadingComponent: require('C:/Users/abrah/Downloads/CMPE280-TP/src/components/PageLoading/index').default,
}),
            "exact": true
          },
  ...
  component: () => import(/* webpackChunkName: "p__Manage__NodesList" */'../Manage/NodesList'),
  LoadingComponent: require('C:/Users/abrah/Downloads/CMPE280-TP/src/components/PageLoading/index').default,
}),
            "exact": true
          },
  ...
  component: () => import(/* webpackChunkName: "p__Manage__ShadowsList" */'../Manage/ShadowsList'),
  LoadingComponent: require('C:/Users/abrah/Downloads/CMPE280-TP/src/components/PageLoading/index').default,
}),
            "exact": true
          },
      ...
      },
      {
        ...
        "routes": [
          {
            "path": "/detail/nodeDetail",
            "name": "nodeDetail",
            "component": _dvaDynamic({
  
  component: () => import(/* webpackChunkName: "p__Detail__NodeDetail" */'../Detail/NodeDetail'),
  LoadingComponent: require('C:/Users/abrah/Downloads/CMPE280-TP/src/components/PageLoading/index').default,
}),
            "exact": true
          },
          {
            "path": "/detail/nodeDetail/:id",
            "name": "nodeDetail",
            "hideInMenu": true,
            "component": _dvaDynamic({
  ...
  LoadingComponent: require('C:/Users/abrah/Downloads/CMPE280-TP/src/components/PageLoading/index').default,
      ...
      },
      {
        ...
        "routes": [
          {
            "path": "/dashboard/demodashboard",
            "name": "demodashboard",
            "component": _dvaDynamic({
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Dashboard__models__activities.js' */'C:/Users/abrah/Downloads/CMPE280-TP/src/pages/Dashboard/models/activities.js').then(m => { return { namespace: 'activities',...m.default}}),
  import(/* webpackChunkName: 'p__Dashboard__models__chart.js' */'C:/Users/abrah/Downloads/CMPE280-TP/src/pages/Dashboard/models/chart.js').then(m => { return { namespace: 'chart',...m.default}}),
  import(/* webpackChunkName: 'p__Dashboard__models__monitor.js' */'C:/Users/abrah/Downloads/CMPE280-TP/src/pages/Dashboard/models/monitor.js').then(m => { return { namespace: 'monitor',...m.default}})
],
  component: () => import(/* webpackChunkName: "p__Dashboard__DemoDashboard" */'../Dashboard/DemoDashboard'),
  LoadingComponent: require('C:/Users/abrah/Downloads/CMPE280-TP/src/components/PageLoading/index').default,
}),
            "exact": true
          },
          {
            "path": "/dashboard/mlcomponent",
...
models: () => [
  ...
  component: () => import(/* webpackChunkName: "p__Dashboard__mlcomponent" */'../Dashboard/mlcomponent'),
  LoadingComponent: require('C:/Users/abrah/Downloads/CMPE280-TP/src/components/PageLoading/index').default,
}),
            "exact": true
          },
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Forms__models__form.js' */'C:/Users/abrah/Downloads/CMPE280-TP/src/pages/Forms/models/form.js').then(m => { return { namespace: 'form',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__List__models__rule.js' */'C:/Users/abrah/Downloads/CMPE280-TP/src/pages/List/models/rule.js').then(m => { return { namespace: 'rule',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Profile__models__profile.js' */'C:/Users/abrah/Downloads/CMPE280-TP/src/pages/Profile/models/profile.js').then(m => { return { namespace: 'profile',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Exception__models__error.js' */'C:/Users/abrah/Downloads/CMPE280-TP/src/pages/Exception/models/error.js').then(m => { return { namespace: 'error',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Account__Settings__models__geographic.js' */'C:/Users/abrah/Downloads/CMPE280-TP/src/pages/Account/Settings/models/geographic.js').then(m => { return { namespace: 'geographic',...m.default}})
],
